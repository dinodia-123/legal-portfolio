      ...
      <div className="row g-5">
        ...
        <div className="col-md-6">
          <div className="p-4 bg-white rounded-4 shadow-sm h-100">
            ...
            <p className="mb-3 text-black"><strong>Address:</strong><br />123 Legal Lane, Connaught Place, New Delhi - 110001</p>
            <p className="mb-3 text-black"><strong>Email:</strong><br /><a href="mailto:contact@dineshbishnoi.com" className="text-decoration-none text-black">contact@dineshbishnoi.com</a></p>
            <p className="mb-3 text-black"><strong>Phone:</strong><br /><a href="tel:+919876543210" className="text-decoration-none text-black">+91 98765 43210</a></p>
            <p className="mb-0 text-black"><strong>Office Hours:</strong><br />Mon–Fri: 9:00 AM – 6:00 PM</p>
          </div>
        </div>
      </div>
    </div>
